  ...
  return (
    <section className="bg-gray-100 text-gray-900 flex flex-col justify-center items-center">
      ...
      <div className="max-w-5xl mx-auto py-16 px-6">
        <h2 className="text-4xl font-bold text-center mb-8">Təlim Proqramı</h2>
        <p className="text-lg leading-relaxed text-gray-700 mb-12 text-center">
          ...
          Data Analitikası və Data Science metodologiyalarını R, Python, Spark,
          Spark SQL, Spark MLlib, AWS, Hadoop, Mongo DB, MapReduce, Hive,
          Hadoop, Tensorflow, Tableau, SPSS, SPSS Modeler öyrədilməsi daxil
          olmaqla 140 saatlıq tədris məzmununu əhatə edəcəkdir.
        </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-stretch space-y-12 md:space-y-0 md:space-x-2">
            {steps.map((step, index) => (
              <div
                key={step.id}
                className="flex-1 rounded-lg p-8 shadow-lg flex flex-col justify-between"
              >
                <div className="flex items-center justify-center w-16 h-16 bg-teal-500 text-2xl font-bold rounded-full mx-auto mb-6">
                  {step.id}
                </div>
