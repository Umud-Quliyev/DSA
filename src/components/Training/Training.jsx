      ...
      <div className="contanierr">
        <div className="training_program_info">
          ...
          <p>
            ...
            Hive, Hadoop, Tenserflow, Tableau, SPSS, SPSS Modeler öyrədilməsi
        ...
        <div className="contanierr">
          ...
          <div className="training__process">
            ...
            <div className="process">
              ...
              <div className="process__desc">
                <p>
                  ...
                  dünyanın ən geniş Data Science tədris proqramlarından biri ilə
                  öyrənəcəksiniz.
                </p>
              </div>
            </div>
            <div className="process ">
              ...
              <div className="process__desc">
                <p>
                  Şəxsi mentorunuz ilə bərabər real layihələr üzərində çalışaraq
                  öyrəndiyiniz bilikləri tətbiq edəcəksiniz.
                </p>
              </div>
            </div>
            <div className="process">
