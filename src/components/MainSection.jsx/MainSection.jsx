...
const MainSection = () => {
  return (
    <div className="bg-[url(./assets/png/main-bg.jpg)] h-[100vh]   w-full">
      <Header />
      <div className="text-[#fff] flex  flex-col items-center gap-3">
        ...
        <div className="bg-[#310d31] rounded-[10px] flex flex-col items-center  p-4">
          <span className="text-[#fecb00] text-[20px]">Data Science Academy</span>
          <h3 className="text-[#fecb00] text-[50px] font-bold ">
            Bootcamp
          </h3> 
